...
mkdir /mnt/var 
mkdir /mnt/home
mount -o nouuid /dev/nvme1n1p1 /mnt/root/
yum -q -y install lvm2 
vgchange -a y vg 
...
mv /mnt/root/var/tmp/* /mnt/var/tmp/
rm -rf /mnt/root/var/tmp/
...
/dev/vg/lv_var_tmp	/var/tmp	xfs	defaults,nosuid,nodev,noexec	0 0
